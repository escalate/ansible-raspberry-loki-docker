...
All tests must pass before submitting any changes. The test suite runs via [GitHub Actions](https://github.com/escalate/ansible-raspberry-loki-docker/actions), and contributions will not be merged unless all tests are successful.
